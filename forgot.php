...
require 'db.php';
require 'mlmc-views/vendor/autoload.php';

// contains a variable called: $API_KEY that is the API Key.
// You need this API_KEY created on the Sendgrid website.
include_once('mlmc-views/credentials.php');
...
{   
    ...
    { 
      ...
      * {
      ...
      <!--<![endif]-->
          <table class='wrapper' style='border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;' cellpadding='0' cellspacing='0' role='presentation'><tbody><tr><td>
            ...
            <div style='mso-line-height-rule: exactly;line-height: 50px;font-size: 1px;'>&nbsp;</div>
                  ...
                  <div style='Margin-left: 20px;Margin-right: 20px;'>
            <div style='mso-line-height-rule: exactly;mso-text-raise: 4px;'>
              <p style='Margin-top: 0;Margin-bottom: 0;'>Good day!<br><br>Kindly click the link below to completely reset your password.
              <br><br>
              Link: localhost/MLMC/reset.php?email=". $email."&hash=".$hash."
              <br><br>
              Thankyou!
              </p>
            </div>
      ...
      $_SESSION['message'] = "Reset link has been sent to your email. Thankyou!";
