<?php include 'admin-header.php' ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Delete User Account</h2>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <form action="delete-confirm.php" method="post" name="editForm">
                             <div class="form-group">
                                  <label>Account ID</label>
                                  <input class="form-control" readonly="readonly" placeholder="<?php echo $accid; ?>">
                            </div>
                            ...
                            <div class="form-group">       
                              ...
                              <input type="text" name="username" class="form-control" value='<?php echo $user; ?>' readonly="readonly">
                            </div>

                            <div class="form-group">       
                              <label>Password </label>
                              <input type="text" name="password" class="form-control" value='<?php echo $pass; ?>' readonly="readonly">
                            </div>
