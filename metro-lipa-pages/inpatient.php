...
<div  ng-app="myApp" ng-controller="userCtrl">
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Inpatient</h3>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                 ...
                 <div >
                        <div class="panel-body">
                            ...
                            <input type="button" class="btn btn-primary" value="Add Patient" onclick="window.location.href='add-patient-form.php';">
                            <!-- <span>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item" ng-click="generateQr()">
...
<script>
   ...
   fetch.controller('userCtrl', ['$scope', '$http', function($scope, $http) {   
       ...
       $http({
           method: 'get',
           url: '../assets/getData/get-inpatient-details.php'
       ...
       $scope.generateQr = function(){
            if($scope.selectedRow != null){
                $http.post("http://localhost/Metro Lipa Patient System/metro-lipa-pages/qr-generator/index.php", {
