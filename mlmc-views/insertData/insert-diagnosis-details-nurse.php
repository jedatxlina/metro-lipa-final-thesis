...
if($labs != ''){
    if(preg_match("/[A-z]/i", $labs)){
        ...
        foreach($labs AS $value){
            ...
            if(is_numeric($value)){
                ...
                $query = "INSERT into orders(OrderID,MedicalID,AdmissionID,PhysicianID,Task,LaboratoryID,DateOrder,TimeOrder,Status,NurseID) 
                VALUES('$orderid','$medicalid','$admissionid','$at','$order','$value','$date','$time','Pending','$nurseat')";
    ...
    VALUES('$orderid','$medicalid','$admissionid','$at','$order','$date','$time','Pending','$nurseat')";
...
header("Location:../post-diagnosis-nurse.php?at=$nurseat&medicationid=$medicationid&id=$admissionid&medicalid=$medicalid");
