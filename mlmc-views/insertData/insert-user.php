    ...
    $FROM_EMAIL = 'themetrolipa@gmail.com';
    ...
    <!--<![endif]-->
        <table class='wrapper' style='border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;' cellpadding='0' cellspacing='0' role='presentation'><tbody><tr><td>
          <div role='banner'>
            ...
            <!--[if (mso)|(IE)]><table align='center' class='header' cellpadding='0' cellspacing='0' role='presentation'><tr><td style='width: 600px'><![endif]-->
              <div class='logo emb-logo-margin-box' style='font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;' align='center'>
                <div class='logo-center' align='center' id='emb-email-header'><img style='display: block;height: auto;width: 100%;border: 0;max-width: 163px;' src='images/header-logo1.jpg' alt='' width='163' /></div>
              </div>
            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
            </div>
          </div>
          <div role='section'>
          <div style='background-color: #662525;'>
            <div class='layout three-col' style='Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;'>
              ...
              <!--[if (mso)|(IE)]><table width='100%' cellpadding='0' cellspacing='0' role='presentation'><tr class='layout-full-width' style='background-color: #662525;'><td class='layout__edges'>&nbsp;</td><td style='width: 200px' valign='top' class='w160'><![endif]-->
          ...
          <div style='mso-line-height-rule: exactly;mso-text-raise: 4px;'>
            <h3 class='size-12' style='Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 12px;line-height: 19px;font-family: Avenir,sans-serif;text-align: center;' lang='x-size-12'><span style='color:#fff'><strong>METRO LIPA MEDICAL CENTER</strong></span></h3>
          </div>
        </div>
          ...
          <div style='background-color: #662525;'>
            <div class='layout one-col' style='Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;'>
              <div class='layout__inner' style='border-collapse: collapse;display: table;width: 100%;'>
              <!--[if (mso)|(IE)]><table width='100%' cellpadding='0' cellspacing='0' role='presentation'><tr class='layout-full-width' style='background-color: #662525;'><td class='layout__edges'>&nbsp;</td><td style='width: 600px' class='w560'><![endif]-->
          ...
          <div style='mso-line-height-rule: exactly;line-height: 50px;font-size: 1px;'>&nbsp;</div>
                ...
                <div style='Margin-left: 20px;Margin-right: 20px;'>
          <div style='mso-line-height-rule: exactly;mso-text-raise: 4px;'>
            <p style='Margin-top: 0;Margin-bottom: 0;'>Good day!<br><br>You have succesfully registered to Metro Lipa Patient Management System. Below are the details of your account. Please be aware that changing of default password is a must.
            <br><br>
            <b>Account ID: </b>". $accountid."<br>
            <b>Password(Default):</b> mlmc<br><br>
            Please click the link to sign in with your default credentials. https://themetrolipa.azurewebsites.net/index.php
            <br><br>
            Thankyou!
            </p>
          </div>
                ...
                <div class='column wide' style='text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);'>
                  <div style='Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;'>
                    ...
                    <div style='font-size: 12px;line-height: 19px;'>
                      <div>Metro Lipa Medical Center</div>
                    </div>
                    <div style='font-size: 12px;line-height: 19px;Margin-top: 18px;'>
                      <div>You are receiving these for you choose to send the report via emal. *Don't reply&nbsp;</div>
                    </div>
                    <!--[if mso]>&nbsp;<![endif]-->
                  </div>
                </div>
