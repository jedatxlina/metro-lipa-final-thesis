...
$bed;
$admissno;
$sel = mysqli_query($conn,"SELECT a.AdmissionNo, b.BedID FROM patients a, medical_details b WHERE a.AdmissionType = 'Inpatient' AND b.AdmissionID = '$id' AND a.AdmissionID = '$id'");
$data = array();
