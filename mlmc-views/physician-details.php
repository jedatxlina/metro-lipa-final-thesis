                                        ...
                                        <fieldset>
                                            ...
                                            <div data-row-span="3">
                                                <div data-field-span="2">
                                                    ...
                                                    <input type="text" ng-model="physicianid" disabled>
                                                </div>
                                                <div data-field-span="1">
                                                    <label>Specialization</label>
                                                    <select ng-model="specialization" class="form-control" ng-options="data.SpecializationName for data in spec | orderBy:'SpecializationName':false track by data.SpecializationID">
                                            ...
                                            <div data-row-span="3">
                                                ...
                                                <div data-field-span="1">
                                                    ...
                                                    <select class="form-control" ng-mode="nationality">  
                                                        <option value="" disabled selected>Select</option>
