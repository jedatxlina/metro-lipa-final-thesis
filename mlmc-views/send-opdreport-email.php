<?php
  ...
  $htmlContent = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional //EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><!--[if IE]><html xmlns='http://www.w3.org/1999/xhtml' class='ie'><![endif]--><!--[if !IE]><!--><html style='margin: 0;padding: 0;' xmlns='http://www.w3.org/1999/xhtml'><!--<![endif]--><head>
    ...
    * {
    ...
    <!--<![endif]-->
        <table class='wrapper' style='border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;' cellpadding='0' cellspacing='0' role='presentation'><tbody><tr><td>
          ...
          <div style='mso-line-height-rule: exactly;mso-text-raise: 4px;'>
            <h3 class='size-12' style='Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 12px;line-height: 19px;font-family: Avenir,sans-serif;text-align: center;' lang='x-size-12'><span style='color:#fff'><strong>DIAGNOSIS REPORT</strong></span></h3>
          </div>
        </div>
          ...
          <div style='mso-line-height-rule: exactly;line-height: 50px;font-size: 1px;'>&nbsp;</div>
                ...
                <div style='Margin-left: 20px;Margin-right: 20px;'>
          <div style='mso-line-height-rule: exactly;mso-text-raise: 4px;'>
            <p style='Margin-top: 0;Margin-bottom: 0;'>Attachede file is your diagnosis report from Metro Lipa Medical Center. Thank you.</p>
          </div>
        </div>
    ...
    file_put_contents('DiagnosisReport.pdf', $pdfString);
        
    $file = 'DiagnosisReport.pdf';
    $file_encoded = base64_encode(file_get_contents($file));
    $attachment = new SendGrid\Attachment();
    $attachment->setContent($file_encoded);
    $attachment->setType("application/text");
    $attachment->setDisposition("attachment");
    $attachment->setFilename("DiagnosisReport.pdf");
